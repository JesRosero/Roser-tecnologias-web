        ...
        return `
            <nav class="navbar">
                <div class="nav-container">
                    ...
                    <div class="cart-icon"
                        onclick="event.preventDefault(); event.stopPropagation(); openCartModal();"
                        style="position: relative; cursor: pointer; display: flex; align-items: center; margin-left: 15px; min-width: 40px; min-height: 40px; justify-content: center;">

                        <img src="${settings.cartIcon}" alt="Carrito" width="24" height="24">

                        <span class="cart-count"
                            id="cart-count"
                            style="position: absolute; top: 2px; right: 2px; background: #ff4444; color: white; border-radius: 50%; width: 16px; height: 16px; display: none; align-items: center; justify-content: center; font-size: 10px; font-weight: bold;">
                            0
                        </span>
                    </div>
                        ...
                        <div class="subsection">
                            ...
                            <div class="sub-subsection">
                                ...
                                <a href="${settings.sidebarBasePath}Productos-Roser/Apps/3dcost/3dcost.html">
                                    <img src="${settings.sidebarBasePath}Imagenes/3D.png" alt="3DCost" class="subsection-icon">
                                    3DCost
                                </a>

                                <a href="${settings.sidebarBasePath}Productos-Roser/Apps/construcost/construcost.html">
                                    <img src="${settings.sidebarBasePath}Imagenes/construcost.webp" alt="ConstruCost" class="subsection-icon">
                                    ConstruCost
                                </a>
